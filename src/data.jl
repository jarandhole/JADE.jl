...
function JADEdata(rundata::RunData)
    ...
    println("Fuel costs in timenow = start_yr, 2: ", fuel_costs[TimePoint(rundata.start_yr, 1)])
    println("Fuel costs in timenow = yr, 2: ", fuel_costs[TimePoint(rundata.start_yr, 2)])
